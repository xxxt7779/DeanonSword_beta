...
╔══════                                               ══════╗
║                                                           ║
                {COLOR_CODE["BLUE"]}[+]ID пользователя: {user_id}
...
╚══════                                               ══════╝
    ...
    if not found:
        print(f'{COLOR_CODE["RED"]}[ошибка]Ничего не найдено в базе данных по номеру телефона,что бы вернутся в тул введи: python main.py.')
